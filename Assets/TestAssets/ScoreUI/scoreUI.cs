...
public class scoreUI : MonoBehaviour
{
    ...
    [Space(15),Tooltip("Good判定の補正値")][Range(-1.0f,1.0f)][SerializeField] private float Good_Correction_value;
    [Space(15),Tooltip("Miss判定の補正値")][Range(-1.0f,1.0f)][SerializeField] private float Miss_Correction_value;
    ...
    void Update()
    {
        if(!isOnce)
        {
            addScore = MAX_Score / (LoadChartData.Data.Notes.Count / 2);    //ノーツ１個の最高点
